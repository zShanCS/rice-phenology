  ...
  useEffect(
    ()=>{
      ...
      if (selectedCropType == 'SK'){
        ...
        console.log(SK_line_data[selectedIndex])
        setData(SK_line_data[selectedIndex])
      }
      else {
        //kainat
        console.log(Kainat_line_data[selectedIndex])
        setData(Kainat_line_data[selectedIndex])
      }
    },
    [selectedCropType, selectedIndex]
  )
